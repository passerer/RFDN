...
class IMDN(nn.Module):
    def __init__(self, in_nc=3, out_nc=3, nc=64, nb=8, upscale=4, act_mode='L', upsample_mode='pixelshuffle', negative_slope=0.05):
        ...
        m_body = [IMDBlock(nc, nc, mode='C'+act_mode, negative_slope=negative_slope) for _ in range(nb)]
        m_body.append(conv(nc, nc, mode='C'))


        m_uper = upsample_pixelshuffle(nc, out_nc, mode=str(upscale))

        self.model = sequential(m_head, ShortcutBlock(sequential(*m_body)), *m_uper)
